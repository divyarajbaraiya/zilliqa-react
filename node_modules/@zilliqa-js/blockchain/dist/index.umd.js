    ...
    ***************************************************************************** */
    ...
    var Blockchain = /** @class */ (function () {
        ...
        Blockchain.prototype.getTotalCoinSupply = function () {
            return this.provider.send("GetTotalCoinSupply" /* GetTotalCoinSupply */);
        };
        /**
         * getMinerInfo
         *
        ...
        Blockchain.prototype.getMinerInfo = function (dsBlockNumber) {
            return this.provider.send("GetMinerInfo" /* GetMinerInfo */, dsBlockNumber);
        };
        /**
         * createTransaction
         *
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.provider.send("CreateTransaction" /* CreateTransaction */, tx)];
                        case 1:
                            response = _a.sent();
                            if (response.error) {
                                throw response.error;
        ...
        Blockchain.prototype.getTxnBodiesForTxBlock = function (txBlock) {
            return this.provider.send("GetTxnBodiesForTxBlock" /* GetTxnBodiesForTxBlock */, txBlock.toString());
        };
        /**
         * getNumTxnsTxEpoch
         *
        ...
        Blockchain.prototype.getPendingTxns = function () {
            return this.provider.send("GetPendingTxns" /* GetPendingTxns */);
        };
        /**
         * getBalance
         *
